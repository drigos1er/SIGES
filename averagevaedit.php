...
$_SESSION['leconccecteva']=$_GET['leconnecte'];
$_SESSION['idanacva']=$_GET['idanac'];
$_SESSION['idspecva']=$_GET['idspec'];
$_SESSION['idsemva']=$_GET['idsem'];
$_SESSION['idueva']=$_GET['idue'];
$_SESSION['idecuva']=$_GET['idecu'];
$_SESSION['catnoteva']=$_GET['typeofaver'];
$_SESSION['idclasseva']=$_GET['idclass'];



header("Location:http://localhost:8888/SIGES/public/teacherarea/validaveragesedit");
