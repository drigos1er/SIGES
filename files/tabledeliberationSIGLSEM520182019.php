...
<page  backbottom="50mm" backtop="1mm" >
    ...
    <table style="border:solid 1px black;  text-align:center; font-size:7px;  border-collapse:collapse; " align="center">
        ...
        <tr><th style="text-align: center; border: solid 1px black; " rowspan="3" height="30"> N°</th>
            ...
            <th style="text-align: center; border: solid 1px black;  " colspan="4">UE 5 RESEAUX ET SYSTEMES AVANCES</th>
        ...
        <tr>
            ...
            <th style="text-align: center; border: solid 1px black;  " colspan="3">PROJET </th>
            <th style="text-align: center; border: solid 1px black;  " rowspan="2" > CREDITS VALIDES</th>
...
<page  backbottom="50mm" backtop="1mm" >
    ...
    <table style="border:solid 1px black;  text-align:center; font-size:7px;  border-collapse:collapse; " align="center">
        ...
        <tr><th style="text-align: center; border: solid 1px black; " rowspan="3" height="30"> N°</th>
            ...
            <th style="text-align: center; border: solid 1px black;  " colspan="8">UE 7 ATELIER DE GENIE LOGICIEL</th>
            <th style="text-align: center; border: solid 1px black;  " colspan="8">UE 8 DEVELOPPEMENT DOTNET</th>
            <th style="text-align: center; border: solid 1px black;  " colspan="4">UE 9 ADMINISTRATION DES BASES DE DONNEES</th>
            <th style="text-align: center; border: solid 1px black;  " colspan="4">UE 10 DEVELOPPEMENT MOBILE</th>
