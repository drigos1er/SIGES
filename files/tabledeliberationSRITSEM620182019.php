...
<page  backbottom="50mm" backtop="1mm" >
    ...
    <table style="border:solid 1px black;  text-align:center; font-size:7px;  border-collapse:collapse; " align="center">
        ...
        <tr><th style="text-align: center; border: solid 1px black; " rowspan="3"> N°</th>
            ...
            <th style="text-align: center; border: solid 1px black;  " colspan="4">UE 2 PROGRAMMATION WEB ET MULTIMEDIA</th>
        ...
        <tr>
            ...
            <th style="text-align: center; border: solid 1px black;  " colspan="3">PROGRAMMATION WEB ET MULTIMEDIA</th>
            <th style="text-align: center; border: solid 1px black;  " rowspan="2" > CREDITS VALIDES</th>
...
SELECT  DISTINCT student_examnotes.studentid FROM `student_examnotes` INNER JOIN student on student.id=student_examnotes.studentid  WHERE  student_examnotes.specialityid=:idspec  and student_examnotes.acadyearid=:idanac  and student_examnotes.semesterid=:idsem and student_examnotes.sessionid=:idses order by student.firstname,student.lastname' );
        ...
        if($decisionsem1=='ADMIS' and tcredit($idetudiant,$idsem,$idanac,$idspec,$idses,$bdd)>=20)
        {
            ...
            <tr><td style="text-align: center; border: solid 1px black; "  height="10px;"> <?php echo $k++;?></td>
                <td style="text-align: center; border: solid 1px black; " > <?php if($result['school_classeid']=="SRITL3"){echo '';}if($result['school_classeid']=="SRITL3A"){echo 'A';}if($result['school_classeid']=="SRITL2B"){echo 'B';}if($result['school_classeid']=="SRITL3C"){echo 'C';}?></td>
                ...
                <td style="text-align: center; border: solid 1px black; " > <?php echo moyenneecu($idetudiant,$idspec,$idsem,'ECU1INF3450',$idanac,$idses,$bdd); ?></td>
                <td style="text-align: center; border: solid 1px black; " > <?php echo creditecu($idsem,'ECU1INF3450',$idanac,$idspec,$bdd); ?></td>

                <td style="text-align: center; border: solid 1px black; " > <?php $moyponde=moyenneecu($idetudiant,$idspec,$idsem,'ECU1INF3450',$idanac,$idses,$bdd)*creditecu($idsem,'ECU1INF3450',$idanac,$idspec,$bdd); echo number_format($moyponde,2); ?></td>

                <td style="text-align: center; border: solid 1px black; "><?php echo creditvalideue($idetudiant,$idsem,'INF3450',$idanac,$idspec,$idses,$bdd); ?></td>
