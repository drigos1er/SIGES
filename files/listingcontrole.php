...
<page  backbottom="10mm" backtop="95mm" >
    ...
    <table width="auto" border="0" cellspacing="0" style="margin-top: 10px">
        ...
        <div  style="margin-top:0px;  text-align:center; font-size:18px;  "> MOYENNES DE CONTRÔLES CONTINUS- ANNEE ACADEMIQUE : <strong><?php echo $idanac; ?></strong><BR /><br><span style="font-size:16px; font-weight:bold;">SPECIALITE :<?php echo $idspec; ?>  &nbsp;&nbsp;- &nbsp;&nbsp;  NIVEAU: <?php echo $levelname; ?><br><br> CLASSE: <?php echo $idclass; ?>&nbsp;&nbsp;- &nbsp;&nbsp;<?php echo $semname; ?></span></div><br>
    ...
    <table style="border:solid 1px black;  text-align:center; font-size:11px;  border-collapse:collapse; " align="center">
        ...
        <tr style="background-color:#d9d9d9;"><th style="text-align: center; border: solid 1px black; "  height="60px;"> N°</th>
            ...
            <th style="text-align: center; border: solid 1px black;  " >MCC</th>

            <th style="text-align: center; border: solid 1px black;  " >MCC  TP</th>
        ...
        while ($identity = $rep->fetch()) {
            ...
            <td style="text-align: center; border: solid 1px black; " > <?php echo $identity['kind'];?></td>
                <td style="text-align: center; border: solid 1px black; " ><?php echo theoaverages($identity['id'],$idsem,$idue,$idecu,$idanac,$bdd)?> </td>
                <td style="text-align: center; border: solid 1px black; " ><?php echo tpaverages($identity['id'],$idsem,$idue,$idecu,$idanac,$bdd)?> </td>
            </tr>
        <?php }?>
        ...
        <tr><td colspan="3"><strong> L'ENSEIGNANT</strong></td>
            <td ><strong> </strong></td>

            <td colspan="3"><strong></strong></td>
        </tr>

        <tr><td colspan="3"><span style="font-style: italic"> <?php echo teachervalid($idsem,$idue,$idecu,$idanac,$idclass,$bdd)?></span></td>
            <td ><strong> </strong></td>
