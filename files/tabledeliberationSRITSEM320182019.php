...
<page  backbottom="50mm" backtop="1mm" >
    ...
    <table style="border:solid 1px black;  text-align:center; font-size:7px;  border-collapse:collapse; " align="center">
        ...
        <tr><th style="text-align: center; border: solid 1px black; " rowspan="3" height="30px;"> N°</th>
            ...
            <th style="text-align: center; border: solid 1px black;  " colspan="4">UE2 FRANCAIS</th>
            <th style="text-align: center; border: solid 1px black;  " colspan="4">UE3 ECONOMIE</th>
            <th style="text-align: center; border: solid 1px black;  " colspan="4">UE4 ARITHMETIQUE</th>
            <th style="text-align: center; border: solid 1px black;  " colspan="4">UE5 SERIES ET INTEGRALES GENERALISEES</th>
            <th style="text-align: center; border: solid 1px black;  " colspan="8">UE6 PHYSIQUES</th>
...
<page  backbottom="50mm" backtop="1mm" >
    ...
    <table style="border:solid 1px black;  text-align:center; font-size:7px;  border-collapse:collapse; " align="center">
        ...
        <tr><th style="text-align: center; border: solid 1px black; " rowspan="3" height="30px;"> N°</th>
            ...
            <th style="text-align: center; border: solid 1px black;  " colspan="8">UE7 ELECTRONIQUES ET APPLICATIONS</th>
            <th style="text-align: center; border: solid 1px black;  " colspan="4">UE8  PROGRAMMATION ORIENTEE OBJET</th>
            <th style="text-align: center; border: solid 1px black;  " colspan="4">UE9 MODELISATION DES BASES DE DONNEES</th>
