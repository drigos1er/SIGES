...
<page  backbottom="5mm" backtop="1mm" >
    ...
    <div  style="margin-top:20px; width:80%; margin-left:100px; text-align:center; font-size:22px; font-weight: bold; border: double; background-color:#CCC;"> STATISTIQUES DE LA PREMIERE  SESSION DE L'ANNEE ACADEMIQUE    &nbsp;  <strong><?php echo  $idanac;?></strong>&nbsp;  </div>
    ...
    <table style="border:solid 1px black;  text-align:left; font-size:11px;  border-collapse:collapse;" align="center">
        ...
        <tr>
            ...
            <td style="text-align: center; border: solid 1px black; background-color: #e5e5e5 ; " height="20px;"><?php $nbpresentL1= $nbpresentanSRITL1 + $nbpresentanTWINL1  + $nbpresentanSIGLL1  + $nbpresentanRTELL1; echo $nbpresentL1 ?></td>
            <td style="text-align: center; border: solid 1px black;  background-color: #e5e5e5 ;" height="20px;"> <?php $nbadmissupzfL1=$nbadmissupzfanSRITL1 + $nbadmissupzfanTWINL1 + $nbadmissupzfanSIGLL1 + $nbadmissupzfanRTELL1; echo $nbadmissupzfL1; ?> </td>
            <td style="text-align: center; border: solid 1px black;  background-color: #e5e5e5 ;" height="20px;"> <?php $nbadmissupzgL1=$nbadmissupzgansSRITL1 + $nbadmissupzgansTWINL1 + $nbadmissupzgansSIGLL1 + $nbadmissupzgansRTELL1;echo $nbadmissupzgL1; ?> </td>
            <td style="text-align: center; border: solid 1px black; background-color: #e5e5e5 ; " height="20px;"><?php $nbadmissupzL1=$nbadmissupzanTWINL1 + $nbadmissupzanSRITL1 + $nbadmissupzanSIGLL1 + $nbadmissupzanRTELL1; echo $nbadmissupzL1 ?> </td>
            ...
            <td style="text-align: center; border: solid 1px black;  background-color: #e5e5e5 ;" height="20px;"> <?php $nbadmisinfdfL1=$nbadmisinfdfanSRITL1 + $nbadmisinfdfanTWINL1  + $nbadmisinfdfanSIGLL1 + $nbadmisinfdfanRTELL1;echo $nbadmisinfdfL1; ?> </td>
            <td style="text-align: center; border: solid 1px black;  background-color: #e5e5e5 ;" height="20px;"> <?php  $nbadmisinfdgL1=$nbadmisinfdganSRITL1 + $nbadmisinfdganTWINL1 + $nbadmisinfdganSIGLL1 + $nbadmisinfdganRTELL1;echo $nbadmisinfdgL1; ?> </td>
            <td style="text-align: center; border: solid 1px black;  background-color: #e5e5e5 ;" height="20px;"><?php  $nbadmisinfdL1=$nbadmisinfdanSRITL1 + $nbadmisinfdanTWINL1 + $nbadmisinfdanSIGLL1 + $nbadmisinfdanRTELL1; echo $nbadmisinfdL1; ?> </td>
            ...
            <td style="text-align: center; border: solid 1px black;  background-color: #e5e5e5 ;" height="20px;"> <?php $nbadmissupdixfL1=$nbadmissupdixfanSRITL1 + $nbadmissupdixfanTWINL1 + $nbadmissupdixfanSIGLL1 + $nbadmissupdixfanRTELL1 ; echo $nbadmissupdixfL1 ?> </td>
        ...
        <tr>
            ...
            <td style="text-align: center; border: solid 1px black; background-color: #e5e5e5 ; " height="20px;"><?php $nbadmissupzL2=$nbadmissupzanRTELL2 + $nbadmissupzanSRITL2 + $nbadmissupzanSIGLL2 + $nbadmissupzanTWINL2; echo $nbadmissupzL2 ?> </td>
        ...
        <tr style="background-color: yellow">
            ...
            <td style="text-align: center; border: solid 1px black; background-color: #e5e5e5 ; " height="20px;"><?php $nbpresentL3= $nbpresentanSRITL3+$nbpresentanRTELL3 +$nbpresentanSIGLL3; echo $nbpresentL3 ?></td>
            <td style="text-align: center; border: solid 1px black;  background-color: #e5e5e5 ;" height="20px;"> <?php $nbadmissupzfL3=$nbadmissupzfanSRITL3+$nbadmissupzfanRTELL3+$nbadmissupzfanSIGLL3; echo $nbadmissupzfL3; ?> </td>
            <td style="text-align: center; border: solid 1px black;  background-color: #e5e5e5 ;" height="20px;"> <?php $nbadmissupzgL3=$nbadmissupzgansSRITL3 + $nbadmissupzgansRTELL3  + $nbadmissupzgansSIGLL3;echo $nbadmissupzgL3; ?> </td>
            <td style="text-align: center; border: solid 1px black; background-color: #e5e5e5 ; " height="20px;"><?php $nbadmissupzL3=$nbadmissupzanRTELL3 + $nbadmissupzanSRITL3 + $nbadmissupzanSIGLL3; echo $nbadmissupzL3 ?> </td>
            ...
            <td style="text-align: center; border: solid 1px black;  background-color: #e5e5e5 ;" height="20px;"> <?php $nbadmisinfdfL3=$nbadmisinfdfanSRITL3+$nbadmisinfdfanRTELL3 +$nbadmisinfdfanSIGLL3;echo $nbadmisinfdfL3; ?> </td>
            <td style="text-align: center; border: solid 1px black;  background-color: #e5e5e5 ;" height="20px;"> <?php  $nbadmisinfdgL3=$nbadmisinfdganSRITL3 + $nbadmisinfdganRTELL3+ $nbadmisinfdganSIGLL3;echo $nbadmisinfdgL3; ?> </td>
            <td style="text-align: center; border: solid 1px black;  background-color: #e5e5e5 ;" height="20px;"><?php  $nbadmisinfdL3=$nbadmisinfdanSRITL3+ $nbadmisinfdanRTELL3 + $nbadmisinfdanSIGLL3; echo $nbadmisinfdL3; ?> </td>
            ...
            <td style="text-align: center; border: solid 1px black;  background-color: #e5e5e5 ;" height="20px;"> <?php $nbadmissupdixfL3=$nbadmissupdixfanSRITL3+$nbadmissupdixfanRTELL3+$nbadmissupdixfanSIGLL3; echo $nbadmissupdixfL3 ?> </td>
            <td style="text-align: center; border: solid 1px black; background-color: #e5e5e5 ; " height="20px;"> <?php $nbadmissupdixgL3 = $nbadmissupdixganSRITL3 + $nbadmissupdixganRTELL3+ $nbadmissupdixganSIGLL3; echo $nbadmissupdixgL3 ?> </td>
            <td style="text-align: center; border: solid 1px black;  background-color: #e5e5e5 ;" height="20px;"><?php $nbadmissupdixL3 = $nbadmissupdixanSRITL3 + $nbadmissupdixanRTELL3 + $nbadmissupdixanSIGLL3; echo $nbadmissupdixL3; ?> </td>
            ...
            <td style="text-align: center; border: solid 1px black;  background-color: #e5e5e5 ;" height="20px;"><?php  $nbadmisdecisfL3=$nbadmisdecisfanSRITL3 + $nbadmisdecisfanRTELL3 + $nbadmisdecisfanSIGLL3; echo $nbadmisdecisfL3; ?></td>
            <td style="text-align: center; border: solid 1px black;  background-color: #e5e5e5 ;" height="20px;">  <?php $nbadmisdecisgL3= $nbadmisdecisganSRITL3 + $nbadmisdecisganRTELL3  + $nbadmisdecisganSIGLL3;echo $nbadmisdecisgL3; ?></td>
            <td style="text-align: center; border: solid 1px black; background-color: #e5e5e5 ; " height="20px;"> <?php $nbadmisdecisL3= $nbadmisdecisanSRITL3 + $nbadmisdecisanRTELL3 + $nbadmisdecisanSIGLL3; echo $nbadmisdecisL3; ?></td>
...
<!--
        <tr>
            ...
            <td style="text-align: center; border: solid 1px black; "><?php $nbpresentanMDSIM1=nbpresentan($idanac,'MDSI','M1',$bdd);echo $nbpresentanMDSIM1 ; ?></td>


            <td style="text-align: center; border: solid 1px black; "> <?php $nbadmissupzfanMDSIM1=nbadmissupzfan($idanac,'MDSI','M1',$bdd); echo $nbadmissupzfanMDSIM1 ; ?> </td>

            <td style="text-align: center; border: solid 1px black; "> <?php $nbadmissupzgansMDSIM1=nbadmissupzgan($idanac,'MDSI','M1',$bdd); echo $nbadmissupzgansMDSIM1; ?> </td>
            <td style="text-align: center; border: solid 1px black; "><?php $nbadmissupzanMDSIM1=nbadmissupzan($idanac,'MDSI','M1',$bdd); echo $nbadmissupzanMDSIM1; ?> </td>
            <td style="text-align: center; border: solid 1px black; "> <?php  $pourcentsupzMDSIM1= number_format((nbadmissupzan($idanac,'MDSI','M1',$bdd)*100)/nbpresentan($idanac,'MDSI','M1',$bdd),2); echo $pourcentsupzMDSIM1;?></td>



            <td style="text-align: center; border: solid 1px black; "> <?php $nbadmisinfdfanMDSIM1=nbadmisinfdfan($idanac,'MDSI','M1',$bdd); echo $nbadmisinfdfanMDSIM1 ;



                ?> </td>
            <td style="text-align: center; border: solid 1px black; "> <?php
                $nbadmisinfdganMDSIM1=nbadmisinfdgan($idanac,'MDSI','M1',$bdd); echo    $nbadmisinfdganMDSIM1;


                ?> </td>
            <td style="text-align: center; border: solid 1px black; "><?php  $nbadmisinfdanMDSIM1=nbadmisinfdan($idanac,'MDSI','M1',$bdd); echo   $nbadmisinfdanMDSIM1;


                ?> </td>
            <td style="text-align: center; border: solid 1px black; "> <?php  $pourcentinfdMDSIM1= number_format((nbadmisinfdan($idanac,'MDSI','M1',$bdd)*100)/nbpresentan($idanac,'MDSI','M1',$bdd),2); echo $pourcentinfdMDSIM1;?></td>


            <td style="text-align: center; border: solid 1px black; "> <?php

                $nbadmissupdixfanMDSIM1=nbadmissupdixfan($idanac,'MDSI','M1',$bdd); echo   $nbadmissupdixfanMDSIM1


                ;?> </td>
            <td style="text-align: center; border: solid 1px black; "> <?php

                $nbadmissupdixganMDSIM1=nbadmissupdixgan($idanac,'MDSI','M1',$bdd); echo   $nbadmissupdixganMDSIM1;


                ?> </td>
            <td style="text-align: center; border: solid 1px black; "><?php
                $nbadmissupdixanMDSIM1=nbadmissupdixan($idanac,'MDSI','M1',$bdd); echo   $nbadmissupdixanMDSIM1;


                ?> </td>
            <td style="text-align: center; border: solid 1px black; "> <?php  $pourcentsupdixMDSIM1= number_format((nbadmissupdixan($idanac,'MDSI','M1',$bdd)*100)/nbpresentan($idanac,'MDSI','M1',$bdd),2); echo $pourcentsupdixMDSIM1;?></td>

            <td style="text-align: center; border: solid 1px black; "><?php

                $nbadmisdecisfanMDSIM1=nbadmisdecisfan($idanac,'MDSI','M1',$bdd); echo   $nbadmisdecisfanMDSIM1;

                ?></td>
            <td style="text-align: center; border: solid 1px black; ">  <?php


                $nbadmisdecisganMDSIM1=nbadmisdecisgan($idanac,'MDSI','M1',$bdd); echo     $nbadmisdecisganMDSIM1;

                ?></td>
            <td style="text-align: center; border: solid 1px black; "> <?php

                $nbadmisdecisanMDSIM1=nbadmisdecisan($idanac,'MDSI','M1',$bdd); echo       $nbadmisdecisanMDSIM1;



                ?></td>
            <td style="text-align: center; border: solid 1px black; "> <?php  $pourcentdecisMDSIM1= number_format((nbadmisdecisan($idanac,'MDSI','M1',$bdd)*100)/nbpresentan($idanac,'MDSI','M1',$bdd),2); echo $pourcentdecisMDSIM1;?></td>
        ...
        <tr>
            ...
            <td style="text-align: center; border: solid 1px black;  background-color: #e5e5e5 ;" height="20px;">  <?php $nbstudentfofclassspecM1=$nbstudentfofclassspecSIGLM1+$nbstudentfofclassspecSITWM1+$nbstudentfofclassspecRTELM1 +$nbstudentfofclassspecRTELM1 +$nbstudentfofclassspecMBDSM1/*+ $nbstudentfofclassspecMDSIM1*/ ; echo $nbstudentfofclassspecM1;?></td>
