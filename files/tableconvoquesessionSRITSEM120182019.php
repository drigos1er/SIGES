...
SELECT  DISTINCT student_examnotes.studentid FROM `student_examnotes` INNER JOIN student on student.id=student_examnotes.studentid  WHERE  student_examnotes.specialityid=:idspec  and student_examnotes.acadyearid=:idanac  and student_examnotes.semesterid=:idsem and student_examnotes.sessionid=:idses and student_examnotes.studentid NOT IN (SELECT studentid from ue_validated where ue_validated.specialityid=:idspec and ue_validated.semesterid=:idsem and  ue_validated.ueid="ANG3100"  ) order by student.firstname,student.lastname' );
    ...
    <table style="border:solid 1px black;  text-align:center; font-size:7px;  border-collapse:collapse; " align="center">
        ...
        <tr>
            ...
            <th style="text-align: center; border: solid 1px black;  " colspan="3">FRANCAIS</th>
            <th style="text-align: center; border: solid 1px black;  " rowspan="2" > CREDITS VALIDES</th>
        ...
        $repos = $bdd->prepare('
SELECT  DISTINCT student_examnotes.studentid FROM `student_examnotes` INNER JOIN student on student.id=student_examnotes.studentid  WHERE  student_examnotes.specialityid=:idspec  and student_examnotes.acadyearid=:idanac  and student_examnotes.semesterid=:idsem and student_examnotes.sessionid=:idses and student_examnotes.studentid NOT IN (SELECT studentid from ue_validated where ue_validated.specialityid=:idspec and ue_validated.semesterid=:idsem and  ue_validated.ueid="FRA3100"  ) order by student.firstname,student.lastname' );
...
SELECT  DISTINCT student_examnotes.studentid FROM `student_examnotes` INNER JOIN student on student.id=student_examnotes.studentid  WHERE  student_examnotes.specialityid=:idspec  and student_examnotes.acadyearid=:idanac  and student_examnotes.semesterid=:idsem and student_examnotes.sessionid=:idses and student_examnotes.studentid NOT IN (SELECT studentid from ue_validated where ue_validated.specialityid=:idspec and ue_validated.semesterid=:idsem and  ue_validated.ueid="DRT3100"  ) order by student.firstname,student.lastname' );
    ...
    <table style="border:solid 1px black;  text-align:center; font-size:7px;  border-collapse:collapse; " align="center">
        ...
        <tr><th style="text-align: center; border: solid 1px black; " rowspan="3" height="30px;"> N°</th>
            ...
            <th style="text-align: center; border: solid 1px black;  " colspan="4">UE  INFORMATIQUE</th>
        ...
        $repos = $bdd->prepare('
SELECT  DISTINCT student_examnotes.studentid FROM `student_examnotes` INNER JOIN student on student.id=student_examnotes.studentid  WHERE  student_examnotes.specialityid=:idspec  and student_examnotes.acadyearid=:idanac  and student_examnotes.semesterid=:idsem and student_examnotes.sessionid=:idses and student_examnotes.studentid NOT IN (SELECT studentid from ue_validated where ue_validated.specialityid=:idspec and ue_validated.semesterid=:idsem and  ue_validated.ueid="INF3100"  ) order by student.firstname,student.lastname' );
...
SELECT  DISTINCT student_examnotes.studentid FROM `student_examnotes` INNER JOIN student on student.id=student_examnotes.studentid  WHERE  student_examnotes.specialityid=:idspec  and student_examnotes.acadyearid=:idanac  and student_examnotes.semesterid=:idsem and student_examnotes.sessionid=:idses and student_examnotes.studentid NOT IN (SELECT studentid from ue_validated where ue_validated.specialityid=:idspec and ue_validated.semesterid=:idsem and  ue_validated.ueid="MTH3100"  ) order by student.firstname,student.lastname' );
    ...
    <table style="border:solid 1px black;  text-align:center; font-size:7px;  border-collapse:collapse; " align="center">
        ...
        <tr><th style="text-align: center; border: solid 1px black; " rowspan="3" height="30px;"> N°</th>
            ...
            <th style="text-align: center; border: solid 1px black;  " colspan="8">UE FONCTIONS A VARIABLES RELLES</th>
...
SELECT  DISTINCT student_examnotes.studentid FROM `student_examnotes` INNER JOIN student on student.id=student_examnotes.studentid  WHERE  student_examnotes.specialityid=:idspec  and student_examnotes.acadyearid=:idanac  and student_examnotes.semesterid=:idsem and student_examnotes.sessionid=:idses and student_examnotes.studentid NOT IN (SELECT studentid from ue_validated where ue_validated.specialityid=:idspec and ue_validated.semesterid=:idsem and  ue_validated.ueid="MTH3101"  ) order by student.firstname,student.lastname' );
    ...
    <table style="border:solid 1px black;  text-align:center; font-size:7px;  border-collapse:collapse; " align="center">
        ...
        <tr><th style="text-align: center; border: solid 1px black; " rowspan="3" height="30px;"> N°</th>
            ...
            <th style="text-align: center; border: solid 1px black;  " colspan="8">UE OPTIQUES ET PHYSIQUES DES DISPOSITIFS</th>
        ...
        $repos = $bdd->prepare('
SELECT  DISTINCT student_examnotes.studentid FROM `student_examnotes` INNER JOIN student on student.id=student_examnotes.studentid  WHERE  student_examnotes.specialityid=:idspec  and student_examnotes.acadyearid=:idanac  and student_examnotes.semesterid=:idsem and student_examnotes.sessionid=:idses and student_examnotes.studentid NOT IN (SELECT studentid from ue_validated where ue_validated.specialityid=:idspec and ue_validated.semesterid=:idsem and  ue_validated.ueid="PHY3100"  ) order by student.firstname,student.lastname' );
    ...
    <table style="border:solid 1px black;  text-align:center; font-size:7px;  border-collapse:collapse; " align="center">
        ...
        <tr><th style="text-align: center; border: solid 1px black; " rowspan="3" height="30px;"> N°</th>
            ...
            <th style="text-align: center; border: solid 1px black;  " colspan="8">UE ELECTRICITE GENERALE</th>
        ...
        $repos = $bdd->prepare('
SELECT  DISTINCT student_examnotes.studentid FROM `student_examnotes` INNER JOIN student on student.id=student_examnotes.studentid  WHERE  student_examnotes.specialityid=:idspec  and student_examnotes.acadyearid=:idanac  and student_examnotes.semesterid=:idsem and student_examnotes.sessionid=:idses and student_examnotes.studentid NOT IN (SELECT studentid from ue_validated where ue_validated.specialityid=:idspec and ue_validated.semesterid=:idsem and  ue_validated.ueid="PHY3101"  ) order by student.firstname,student.lastname' );
