...
<tbody>
        <tr>
            ...
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbpresent=nbpresentofclasssem($idanac,$idspec,$idsem,$idses,$idue,$idecu,$idclass,$bdd); echo $nbpresent;?> </td>
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbavergtzf=nbavergtzfofclasssem($idanac,$idspec,$idsem,$idses,$idue,$idecu,$idclass,$bdd); echo $nbavergtzf;?> </td>
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbavergtzg=nbavergtzgofclasssem($idanac,$idspec,$idsem,$idses,$idue,$idecu,$idclass,$bdd); echo $nbavergtzg;?>   </td>
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbavergtz=nbavergtzofclasssem($idanac,$idspec,$idsem,$idses,$idue,$idecu,$idclass,$bdd); echo $nbavergtz;?></td>
            ...
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbaverlttf=nbaverlttfofclasssem($idanac,$idspec,$idsem,$idses,$idue,$idecu,$idclass,$bdd); echo $nbaverlttf;?> </td>
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbaverlttg=nbaverlttgofclasssem($idanac,$idspec,$idsem,$idses,$idue,$idecu,$idclass,$bdd); echo $nbaverlttg;?>   </td>
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbaverltt=nbaverlttofclasssem($idanac,$idspec,$idsem,$idses,$idue,$idecu,$idclass,$bdd); echo $nbaverltt;?></td>
            ...
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbavergttf=nbavergttfofclasssem($idanac,$idspec,$idsem,$idses,$idue,$idecu,$idclass,$bdd); echo $nbavergttf;?> </td>
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbavergttg=nbavergttgofclasssem($idanac,$idspec,$idsem,$idses,$idue,$idecu,$idclass,$bdd); echo $nbavergttg;?>   </td>
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbavergtt=nbavergttofclasssem($idanac,$idspec,$idsem,$idses,$idue,$idecu,$idclass,$bdd); echo $nbavergtt;?></td>
            ...
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $averofclasse= averageofclasssem($idanac,$idspec,$idsem,$idses,$idue,$idecu,$idclass,$bdd); echo $averofclasse;?> </td>
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $avermaxofclasse=averagemaxofclasssem($idanac,$idspec,$idsem,$idses,$idue,$idecu,$idclass,$bdd); echo $avermaxofclasse;?> </td>
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $averminofclasse=averageminofclasssem($idanac,$idspec,$idsem,$idses,$idue,$idecu,$idclass,$bdd); echo $averminofclasse;?> </td>
