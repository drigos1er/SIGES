...
<page  backbottom="15mm" backtop="70mm" >
    ...
    <page_header>
        ...
        <span style="margin-left:100px;font-size:16px; "><strong> RESULTATS  DE LA 1<sup>ère</sup> SESSION DE L'ANNEE ACADEMIQUE <?php echo  $idanac;?></strong></span><br><span style="margin-left:300px;font-size:18px; "><strong><?php echo  $levelid;?> :<?php echo  $idspec;?></strong></span><br><span style="margin-left:220px;font-size:14px; "><strong>(LISTE DES ADMIS PAR ORDRE DE MERITE)</strong></span><br><br>
    ...
    <table style="border:solid 1px black;  text-align:center; font-size:11px;  border-collapse:collapse; " align="center">
        ...
        $repos = $bdd->prepare(' SELECT  DISTINCT student_speciality.studentid FROM `student_speciality` INNER JOIN student on student.id=student_speciality.studentid WHERE  student_speciality.specialityid=:idspec  and student_speciality.acadyearid=:idanac  and student_speciality.levelid=:idniv  order by student.firstname,student.lastname ' );
