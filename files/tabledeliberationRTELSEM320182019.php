...
<page  backbottom="50mm" backtop="1mm" >
    ...
    <table style="border:solid 1px black;  text-align:center; font-size:7px;  border-collapse:collapse; " align="center">
        ...
        <tr><th style="text-align: center; border: solid 1px black; " rowspan="3" height="30"> N°</th>
            ...
            <th style="text-align: center; border: solid 1px black;  " colspan="4">UE 5 RESEAUX</th>
...
<page  backbottom="50mm" backtop="1mm" >
    ...
    <table style="border:solid 1px black;  text-align:center; font-size:7px;  border-collapse:collapse; " align="center">
        ...
        <tr><th style="text-align: center; border: solid 1px black; " rowspan="3" height="30"> N°</th>
            ...
            <th style="text-align: center; border: solid 1px black;  " colspan="8">UE 6 MATHEMATIQUES APPLIQUEES</th>
            <th style="text-align: center; border: solid 1px black;  " colspan="4">UE 7 TRANSMISSION ANALOGIQUE / NUMERIQUE</th>
            <th style="text-align: center; border: solid 1px black;  " colspan="4">UE 8 PROGRAMMATION ORIENTEE OBJET</th>
            <th style="text-align: center; border: solid 1px black;  " colspan="4">UE 9 FILTRAGE ANALOGIQUE</th>
