...
<page  backbottom="10mm" backtop="50mm" >
    ...
    <table style="border:solid 1px black;  text-align:center; font-size:11px;  border-collapse:collapse; " align="center">
        ...
        foreach($tabidsem as $idetud) {
            ...
            $moyennesemestreid = moyennnesemestrielle($idetud,'SEM5',$idanac,$idspec,$idses,$bdd);
            ...
            if(decisionsemestrielle($identite['id'],'SEM5',$idanac,$idspec,$idses,$bdd)=='ADMIS'){
                ?>
