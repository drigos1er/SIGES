...
<page backbottom="5mm" backtop="95mm" >
    ...
    <page_header>
        ...
        <div  style="margin-top:0px;  text-align:center; font-size:18px;  ">STATISTIQUES  MOYENNES SEMESTRIELLES- ANNEE ACADEMIQUE : <strong><?php echo $idanac; ?></strong><BR /><br><span style="font-size:16px; font-weight:bold;">SPECIALITE :<?php echo $idspec; ?>  &nbsp;&nbsp;- &nbsp;&nbsp;  NIVEAU: <?php echo $levelname; ?><br><br> <?php echo $semname; ?> - &nbsp;&nbsp;<?php echo $libses; ?></span></div><br>
...
<tbody>
        <tr>
            ...
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbpresent=nbpresentofclassspec($idanac,$idspec,$idsem,$idses,$idue,$idecu,$levelid,$bdd); echo $nbpresent;?> </td>
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbavergtzf=nbavergtzfofclassspec($idanac,$idspec,$idsem,$idses,$idue,$idecu,$levelid,$bdd); echo $nbavergtzf;?> </td>
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbavergtzg=nbavergtzgofclassspec($idanac,$idspec,$idsem,$idses,$idue,$idecu,$levelid,$bdd); echo $nbavergtzg;?>   </td>
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbavergtz=nbavergtzofclassspec($idanac,$idspec,$idsem,$idses,$idue,$idecu,$levelid,$bdd); echo $nbavergtz;?></td>
            ...
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbaverlttf=nbaverlttfofclassspec($idanac,$idspec,$idsem,$idses,$idue,$idecu,$levelid,$bdd); echo $nbaverlttf;?> </td>
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbaverlttg=nbaverlttgofclassspec($idanac,$idspec,$idsem,$idses,$idue,$idecu,$levelid,$bdd); echo $nbaverlttg;?>   </td>
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbaverltt=nbaverlttofclassspec($idanac,$idspec,$idsem,$idses,$idue,$idecu,$levelid,$bdd); echo $nbaverltt;?></td>
            ...
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbavergttf=nbavergttfofclassspec($idanac,$idspec,$idsem,$idses,$idue,$idecu,$levelid,$bdd); echo $nbavergttf;?> </td>
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbavergttg=nbavergttgofclassspec($idanac,$idspec,$idsem,$idses,$idue,$idecu,$levelid,$bdd); echo $nbavergttg;?>   </td>
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbavergtt=nbavergttofclassspec($idanac,$idspec,$idsem,$idses,$idue,$idecu,$levelid,$bdd); echo $nbavergtt;?></td>
            ...
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $averofclasse= averageofclassspec($idanac,$idspec,$idsem,$idses,$idue,$idecu,$levelid,$bdd); echo $averofclasse;?> </td>
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $avermaxofclasse=averagemaxofclassspec($idanac,$idspec,$idsem,$idses,$idue,$idecu,$levelid,$bdd); echo $avermaxofclasse;?> </td>
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $averminofclasse=averageminofclassspec($idanac,$idspec,$idsem,$idses,$idue,$idecu,$levelid,$bdd); echo $averminofclasse;?> </td>
