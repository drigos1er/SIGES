...
<tbody>
        <tr>
            ...
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbpresent=nbpresentofclassaverspec($idanac,$idspec,$idsem,$idue,$idecu,$typeaver,$levelid,$bdd); echo $nbpresent;?> </td>
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbavergtzf=nbavergtzfofclassaverspec($idanac,$idspec,$idsem,$idue,$idecu,$typeaver,$levelid,$bdd); echo $nbavergtzf;?> </td>
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbavergtzg=nbavergtzgofclassaverspec($idanac,$idspec,$idsem,$idue,$idecu,$typeaver,$levelid,$bdd); echo $nbavergtzg;?>   </td>
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbavergtz=nbavergtzofclassaverspec($idanac,$idspec,$idsem,$idue,$idecu,$typeaver,$levelid,$bdd); echo $nbavergtz;?></td>
            ...
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbaverlttf=nbaverlttfofclassaverspec($idanac,$idspec,$idsem,$idue,$idecu,$typeaver,$levelid,$bdd); echo $nbaverlttf;?> </td>
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbaverlttg=nbaverlttgofclassaverspec($idanac,$idspec,$idsem,$idue,$idecu,$typeaver,$levelid,$bdd); echo $nbaverlttg;?>   </td>
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbaverltt=nbaverlttofclassaverspec($idanac,$idspec,$idsem,$idue,$idecu,$typeaver,$levelid,$bdd); echo $nbaverltt;?></td>
            ...
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbavergttf=nbavergttfofclassaverspec($idanac,$idspec,$idsem,$idue,$idecu,$typeaver,$levelid,$bdd); echo $nbavergttf;?> </td>
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbavergttg=nbavergttgofclassaverspec($idanac,$idspec,$idsem,$idue,$idecu,$typeaver,$levelid,$bdd); echo $nbavergttg;?>   </td>
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $nbavergtt=nbavergttofclassaverspec($idanac,$idspec,$idsem,$idue,$idecu,$typeaver,$levelid,$bdd); echo $nbavergtt;?></td>
            ...
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $averofclasse=averageofclassaverspec($idanac,$idspec,$idsem,$idue,$idecu,$typeaver,$levelid,$bdd); echo $averofclasse;?> </td>
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $avermaxofclasse=averagemaxofclassaverspec($idanac,$idspec,$idsem,$idue,$idecu,$typeaver,$levelid,$bdd); echo $avermaxofclasse;?> </td>
            <td style="text-align: center; border: solid 1px black; " height="10px;"><?php $averminofclasse=averageminofclassaverspec($idanac,$idspec,$idsem,$idue,$idecu,$typeaver,$levelid,$bdd); echo $averminofclasse;?> </td>
